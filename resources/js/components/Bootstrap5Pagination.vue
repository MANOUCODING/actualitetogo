<template>
    ...
    <div class="col-12">
        <nav class="mb-4 d-flex justify-content-center" aria-label="navigation">
            ...
            <li class="page-item disabled" :class="{'disabled': !slotProps.computed.prevPageUrl}" v-if="slotProps.computed.prevPageUrl || showDisabled">
                <a class="page-link" href="#" aria-label="Previous" :tabindex="!slotProps.computed.prevPageUrl && -1" v-on="slotProps.prevButtonEvents">Préc.</a>
            </li>
            ...
            <li class="page-item" :class="{'disabled': !slotProps.computed.nextPageUrl}" v-if="slotProps.computed.nextPageUrl || showDisabled">
