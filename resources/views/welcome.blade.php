							...
							<div class="card-img-overlay d-flex flex-column p-3 p-sm-5"> 
								...
								<div class="w-100 mt-auto">
									<div class="col">
										...
										<!-- Card title -->
										<h2 class="text-white "><a href="post-single-4.html" class="btn-link text-reset stretched-link fw-normal">Never underestimate the influence of social media</a></h2>
							...
							<div class="card-img-overlay d-flex align-items-center p-3 p-sm-5"> 
								<div class="w-100 mt-auto">
									<div class="col">
										...
										<!-- Card title -->
										<h2 class="text-white "><a href="post-single-4.html" class="btn-link text-reset stretched-link fw-normal">This is why this year will be the year of startups</a></h2>
			...
			<div class="col-lg-5 mt-5 mt-lg-0">
				...
				<div class="card mb-4">
					<div class="row g-3">
						...
						<div class="col-8">
							<a href="#" class="badge text-bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Lifestyle</a>
							<h6><a href="post-single-4.html" class="btn-link text-reset stretched-link fw-bold">The pros and cons of business agency</a></h6>
							<!-- Card info -->
				...
				<div class="card mb-4">
					<div class="row g-3">
						...
						<div class="col-8">
							...
							<h6><a href="post-single-4.html" class="btn-link text-reset stretched-link fw-bold">5 reasons why you shouldn't startup</a></h6>
							<!-- Card info -->
							<ul class="nav nav-divider align-items-center d-none d-sm-inline-block small">
								<li class="nav-item">
									<div class="nav-link">
				...
				<div class="card mb-4">
					<div class="row g-3">
						...
						<div class="col-8">
							...
							<h6><a href="post-single-4.html" class="btn-link text-reset stretched-link fw-bold">Five unbelievable facts about money.</a></h6>
							<!-- Card info -->
							<ul class="nav nav-divider align-items-center d-none d-sm-inline-block small">
								<li class="nav-item">
									<div class="nav-link">
				...
				<div class="card mb-4">
					<div class="row g-3">
						...
						<div class="col-8">
							...
							<h6><a href="post-single-4.html" class="btn-link text-reset stretched-link fw-bold">Around the web: 20 fabulous infographics about business</a></h6>
							<!-- Card info -->
							<ul class="nav nav-divider align-items-center d-none d-sm-inline-block small">
								<li class="nav-item">
									<div class="nav-link">
