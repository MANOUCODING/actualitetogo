        ...
        <div class="offcanvas-body d-flex flex-column pt-0">
            <div>
                <a class="navbar-brand" href="/">
                    <img class="navbar-brand-item light-mode-item" src="/assets/admin/img/logo.png" style="width: 200px; height: 65px;" alt="logo">
                </a> <br>
                ...
                <div  class="row">
                    ...
                    <div class="col-md-3 mt-3">
                        ...
                        <div class="d-sm-flex justify-content-sm-between align-items-sm-center my-2">
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="nav-link px-2 fs-5 text-primary" href="https://www.facebook.com/Togoactualite-148480121847124" target="_blank"><i class="fab fa-2x fa-facebook-square"></i></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="dropdown-menu dropdown-animation dropdown-menu-end dropdown-menu-size-md p-0 shadow-lg border-0">
                                    <div class="card bg-transparent">
                                        <div class="card-header bg-transparent border-bottom p-3 d-flex justify-content-between align-items-center">
                                            <h6 class="m-0">Notifications <span class="badge bg-danger bg-opacity-10 text-danger ms-2">3 nouvelles</span></h6>
